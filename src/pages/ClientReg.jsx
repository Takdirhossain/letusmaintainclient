...
const ClientReg = () => {
  ...
  const handalesubmit = (e) => {
    ...
    const Propertyno = e.target.Propertyno.value 
    ...
    fetch("https://api.letusmaintain.com/subscription", {
      method: "POST",
      headers: {
  ...
  <label htmlFor="country">Timings Schedule*</label>
  <div className="flex flex-wrap items-center mt-1">
    ...
    <div className="flex items-center mr-5 mb-2">
      <input
        ...
        value="yes"
      />
      <span>06:00 pm to 02:00 am</span>
    </div>
    <div className="flex items-center mr-5 mb-2">
      <input
        className="mr-1"
        ...
        value="yes"
      />
      <span>02:00 am to 10:00 am</span>
    </div>
  </div>
